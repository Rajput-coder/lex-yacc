...
;
type1:INT varlist SC NL { printf("Syntax is correct"); return 0;}
/// for "int a" Test case(without SC ;) NL is added at end otherwise it waits for input
;
type2:FLOAT varlist2 SC NL{ printf("Syntax is correct");return 0;}
;
type3:CHAR varlist3 SC NL{ printf("Syntax is correct");return 0;}
;
type4:BL varlist4 SC NL{ printf("Syntax is correct");return 0;}
;
